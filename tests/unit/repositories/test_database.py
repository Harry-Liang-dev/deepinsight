...
EXPECTED_SCHEMA = {
    ...
    "sector_anomaly_scopes": ("event_id", "scope_id"),
    "phase2_registry": (
        "module_name",
        "api_path",
        "class_path",
...
EXPECTED_PRIMARY_KEYS = {
    ...
    "research_dataset_samples": ("sample_id",),
    "llm_cache": ("cache_key",),
    "ingestion_jobs": ("job_id",),
    "report_jobs": ("job_id",),
    "sector_nodes": ("node_id", "valid_from", "version"),
    "sector_edges": ("edge_id", "valid_from", "version"),
    "sector_memberships": (
        "asset_id",
        "sector_id",
        "role",
    ...
    "research_scopes": ("scope_id", "valid_from", "version"),
    "sector_benchmark_mappings": ("sector_id", "valid_from", "version"),
    "sector_universe_snapshots": ("snapshot_id",),
    "sector_research_snapshots": ("snapshot_id",),
    "sector_macro_snapshots": ("snapshot_id",),
    "sector_anomaly_events": ("event_id",),
    "sector_anomaly_scopes": ("event_id", "scope_id"),
